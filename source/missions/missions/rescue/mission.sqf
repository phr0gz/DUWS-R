...
[west, "_taskhandle", ["One of our patrols has been ambushed and requires immediate assistance", _mission_name, "(getMarkerPos str(_markername)"], objNull, true] call BIS_fnc_taskCreate; 

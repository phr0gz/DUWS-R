...
if (support_armory_available) then {
	[[_ammo,["<t color='#ff1111'>Armory</t>","VAS\open.sqf",[], 0, false, false, "", "_this distance _target < 4"]],"addAction",true,true] call BIS_fnc_MP;
	[[_ammo,["<t color='#11ff11'>Virtual Arsenal</t>","arsenalbox.sqf",[], 0, false, false, "", "_this distance _target < 4"]],"addAction",true,true] call BIS_fnc_MP;
};

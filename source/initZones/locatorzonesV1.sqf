...
public_zones_array = [] + _zones_array;
publicVariable "public_zones_array";
[{_warcom_init = [public_zones_array, getpos hq_blu1, [0,0,0], blufor_ap, opfor_ap, 2700,blufor_ai_skill,opfor_ai_skill, 2000] execVM "WARCOM\WARCOM_init.sqf";},"BIS_fnc_call",true,false] spawn BIS_fnc_MP;

...
if (isMultiplayer) then {
	...
	"support_armory_available" addPublicVariableEventHandler {hq_blu1 addaction ["<t color='#ff1111'>Armory</t>","VAS\open.sqf"];lbSetColor [2103, 5, [0, 1, 0, 1]];};
	"support_armory_available" addPublicVariableEventHandler {hq_blu1 addaction ["<t color='#11ff11'>Virtual Arsenal</t>", "arsenalbox.sqf"];lbSetColor [2103, 5, [0, 1, 0, 1]];};
